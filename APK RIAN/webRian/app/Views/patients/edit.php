...
<body>
    <div class="content">
        ...
        <!-- Formulir untuk edit pasien -->
        <form action="<?= site_url('patients/update/' . $patient['patient_id']) ?>" method="POST">
            <label for="name">Nama Pasien</label>
            <input type="text" id="name" name="name" value="<?= old('name', $patient['name']) ?>" required>

            <label for="dob">Tanggal Lahir</label>
            <input type="date" id="dob" name="dob" value="<?= old('dob', $patient['dob']) ?>" required>

            <label for="address">Alamat</label>
            <input type="text" id="address" name="address" value="<?= old('address', $patient['address']) ?>" required>
