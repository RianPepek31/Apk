...
<body>
    <div class="content">
        ...
        <form action="<?= site_url('appointments/update/' . $appointment['appointment_id']) ?>" method="post">
            <label for="patient_id">ID Pasien:</label>
            <input type="text" id="patient_id" name="patient_id" value="<?= $appointment['patient_id'] ?>" required>
            <br>
            <label for="doctor_id">ID Dokter:</label>
            <input type="text" id="doctor_id" name="doctor_id" value="<?= $appointment['doctor_id'] ?>" required>
            <br>
